  ...
  return (
    <div className="relative min-h-screen bg-[#0f172a] flex flex-col items-center justify-center pt-32 pb-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-8 leading-[1.15] drop-shadow-xl mt-8 px-2">
        ...
        {/* Subtext */}
        <p className="text-slate-400 text-xl md:text-2xl max-w-2xl mx-auto mb-12 leading-relaxed font-light">
